...
$string['key91'] = 'Некоторые из преподавателей давно не заходили в курс';
$string['key92'] = 'Допустимая неактивность преподавателей';
$string['key93'] = 'Срок, по истечении которого преподаватель считается давно не заходившим в курс';
$string['key94'] = 'Ограничение по времени';
$string['key95'] = 'В некоторые тестах нет ограничения по времени';
