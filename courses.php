...
$PAGE->set_url(new moodle_url('/blocks/sibcms/courses.php', array('category' => $categoryid)));
...
$category_table = new block_sibcms\output\category_courses_table($categoryid, $page);
